...
public class ToolUtil {
    ...
    public static List<TraitContainer> getStackTraits(ItemStack stack)
    {
        ...
        ApiToolRecipe recipe = ApiToolRecipeRegistry.getRecipeByType(toolItem.getToolType());
        ...
        for(String part : parts)
        {
            ...
            partCategories.add(ApiPartRegistry.getPrePartCategory(part));
        }
        ...
        for(int i = 0; i < materialKeys.size(); i++)
        {
            ...
            material = ApiMaterialRegistry.getMaterial(materialKey);
