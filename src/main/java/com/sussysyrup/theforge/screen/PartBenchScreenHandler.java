...
public class PartBenchScreenHandler extends ScreenHandler {
    ...
    public void onContentChanged(Inventory inventory) {
        ...
        MaterialResource materialResource = ForgeMaterialRegistry.getMaterialResource(Registry.ITEM.getId(inventory.getStack(0).getItem()).toString());
        ...
        if(materialResource != null)
        {
            for(int i = 2; i < 20; i++)
            {
                if(i - 2 + outputShift < partNames.size())
                {
                    ...
                    cost = ForgePartRegistry.getPartCost(part);
    ...
    private static class ResultSlot extends Slot
    {
        ...
        public void onTakeItem(PlayerEntity player, ItemStack stack) {
            ...
            float partCost = ForgePartRegistry.getPartCost(strings[1]);
