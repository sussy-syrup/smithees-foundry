...
public class PartBenchBlock extends BlockWithEntity {
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return world.isClient() ? checkType(type, ForgePartBenchRegistry.PART_BENCH_BLOCK_ENTITY, PartBenchBlockEntity::clientTicker) : checkType(type, ForgePartBenchRegistry.PART_BENCH_BLOCK_ENTITY, PartBenchBlockEntity::serverTicker);
    }
